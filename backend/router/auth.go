...
func registerAuthRoutes(group *echo.Group, auth *controller.AuthController, authMiddleware, requireRefresh, originValidation, rateLimit echo.MiddlewareFunc) {
	...
	group.POST("/auth/logout", auth.Logout, authMiddleware, originValidation, rateLimit)
